...
const KnownBugsPage = () => (
  <>
    ...
    <ul>
      <li><strong>Synkroniseringsfel:</strong> Ibland kan datalagerstatus (visad/dold) inte synkroniseras korrekt mellan huvudmenyn och 3D-vyn. Funkar vid vissa builds, funkar ej på andra, vetee fan varför.</li>
